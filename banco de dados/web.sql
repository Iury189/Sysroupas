...
(2, 'Bermuda de fio 30.1', 'Bermuda', 'TOMMY HILFIGER', '5-409728-362137', 'Cinza', 'M', 'M', 30, '9.87', 80, '17.77', '2021-08-14 14:08:08');
...
--
ALTER TABLE `entrada`
  MODIFY `cd_entrada` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `produtos_entrada`
  MODIFY `cd_produto_entrada` int(11) NOT NULL AUTO_INCREMENT;
